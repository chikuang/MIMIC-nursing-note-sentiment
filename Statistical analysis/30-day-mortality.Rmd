...
#knitr::opts_knit$set(root.dir = "~/Documents/MIMIC-nursing-note-sentiment/Statistical analysis")
```
...
sapsii_df <- read_csv(paste0(data_dir, "sapsii_df.csv"))
notes_df <- fread(paste0(data_dir, "notes_df_sntmnt.csv"))
mimicii_patients_df <- read.csv(paste0(data_dir, "mimic2_patients_df.csv"))
mimicii_admissions_df <- read.csv(paste0(data_dir, "mimic2_admissions_df.csv"))

# change the type as fread reads as "hadm_id" in chr
notes_df <- notes_df %>%
